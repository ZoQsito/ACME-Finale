    ...
    <section className="home-page-container">
      ...
      <div>
        ...
        <blockquote className="deschome">
          Nous sommes fiers de vous présenter notre collection de chaussures de
          sport haut de gamme, conçue avec les meilleurs matériaux pour offrir
          une expérience de confort et de performance inégalée. Notre équipe de
          designers a travaillé sans relâche pour créer des designs uniques et
          audacieux, tout en veillant à ce que chaque paire de chaussures soit
          fonctionnelle et durable.
          <br />
          <br />
          Que vous soyez un athlète professionnel cherchant à améliorer vos
          performances, ou simplement un amateur de sneakers à la recherche
          d'une paire de chaussures confortables pour vos activités
          quotidiennes, nous avons ce qu'il vous faut.
        </blockquote>
      </div>
      <div className="liste-deroulante-home">
        <tr>
          <button className="liste-deroulante-une" onClick={handleClick}>
            01
          </button>
        </tr>
        <tr>
          <button onClick={handleClick2} className="liste-deroulante-deux">
            02
          </button>
        </tr>
        <tr>
